"""Transkribuje novu audio poruku (New Recording 2.m4a) via Groq i dopisuje u RAW md."""
...
TARGET = ROOT / "Feedback_Loop" / "2026-04-17" / "New Recording 2.m4a"
RAW_MD = ROOT / "Feedback_Loop" / "2026-04-17" / "Feedback_2026-04-17_v2_RAW.md"
...
md = [
    f"# Predator Laser Tag — Feedback transcript 2026-04-17 v2 (evening recording)",
    "",
    f"- **File:** `{TARGET.name}`",
...
print(f"[done] wrote {RAW_MD.name} — {dur/60:.1f} min, {len(segs)} segments")
